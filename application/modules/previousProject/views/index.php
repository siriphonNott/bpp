    ...
    <div class="container">
        <div class="row">
            ...
            <ol class="col-sm-6 text-right breadcrumb">
                ...
                <li class="active">previous project</li>
            </ol>
        </div>
...
<section id="portfolio" class="container-fluid portfolio-layout portfolio-columns-fw">
    ...
    <div class="row">
        <ul id="pfolio-filters" class="portfolio-filters">
            ...
            <li>
                <a href="#" data-filter=".satreewit2">Townhome with Private Garden : Satreewit 2</a>
            </li>
            <li>
                <a href="#" data-filter=".private-courtyard">Townhome with Private Courtyard</a>
            </li>
            <li>
                <a href="#" data-filter=".renovation">Townhome Renovation</a>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div id="pfolio">
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc01.jpg"
                        alt="project30">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc01.jpg"
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc02.jpg"
                        alt="project32">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc02.jpg"
                        class="open-btn open-gallery">
                        <i class="fa fa-expand"></i>
                    </a>
                </div>
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc03.jpg"
                        alt="project33">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc04.jpg"
                        class="open-btn open-gallery">
                        <i class="fa fa-expand"></i>
                    </a>
                </div>
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc04.jpg"
                        alt="project33">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc05.jpg"
                        class="open-btn open-gallery">
                        <i class="fa fa-expand"></i>
                    </a>
                </div>
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc05.jpg"
                        alt="project33">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc06.jpg"
                        class="open-btn open-gallery">
                        <i class="fa fa-expand"></i>
                    </a>
                </div>
            ...
            <div class="col-md-4 portfolio-item private-courtyard">
                <div class="p-wrapper hover-default">
                    <img src="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc06.jpg"
                        alt="project33">
                    <div class="p-hover">
                        <div class="p-content">
                            <!-- <h4>Project Name</h4> -->
                    ...
                    <a href="<?php echo config_item('assets'); ?>images/bg/previous-projects/townhome-with-private-courtyard/previous-pc03.jpg"
                        class="open-btn open-gallery">
                        <i class="fa fa-expand"></i>
                    </a>
                </div>
